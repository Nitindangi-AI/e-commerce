...
const KNOWLEDGE_BASE = [
  ...
  },
  {
    ...
    a: "Check delivery availability by entering your pincode on any product page. We serve **500+ cities** across India.",
...
function handleSmallTalk(input) {
  ...
  if (greetings.some((g) => lower === g || lower === g + "!") || lower.match(/^(hi|hello|hey)\b/)) {
    return `${getGreeting()} Welcome to **LUXE** support! How can I help you today? You can ask me about orders, shipping, returns, your account, or anything else! 😊`;
  }
  ...
  if (byes.some((b) => lower.includes(b))) {
    return "Goodbye! 👋 Thank you for chatting with **LUXE** support. Have a wonderful day! We're here 24/7 if you need us.";
  }
      ...
      <div className={`chatbot-window ${isOpen ? "chatbot-window--open" : ""}`}>
        ...
        <div className="chatbot-header">
          <div className="chatbot-header-info">
            <div className="chatbot-avatar">
              <span className="display text-sm font-bold">L</span>
              <span className="chatbot-online-dot" />
            </div>
            <div>
              <h3 className="chatbot-header-title display">LUXE Support</h3>
            ...
            <div key={i} className={`chatbot-msg chatbot-msg--${msg.type}`}>
              {msg.type === "bot" && (
                <div className="chatbot-msg-avatar">
                  <span className="display text-[10px] font-bold">L</span>
                </div>
              )}
        ...
        <div className="chatbot-input-area">
          ...
          <div className="chatbot-input-hint">
            Press Enter to send · Powered by <span className="gold">LUXE</span>
          </div>
        </div>
      </div>
    </>
