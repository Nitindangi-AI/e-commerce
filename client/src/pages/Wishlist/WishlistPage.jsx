    ...
    <div className="max-w-7xl mx-auto px-6 pt-28 pb-20 min-h-screen">
      ...
      {wishlistItems.length === 0 ? (
        <div className="text-center py-24 border border-white/5 rounded-2xl bg-luxe-card">
          ...
          <p className="text-white/50 text-lg mb-2">Your wishlist is empty</p>
          <p className="text-white/30 text-sm mb-8">Save items you love to your wishlist.</p>
          <Link to="/shop" className="btn-gold px-8 py-3 rounded-full text-sm tracking-widest uppercase">
            Explore Products
          </Link>
        </div>
      ) : (
