        ...
        <main className="flex-1 px-6 py-6 min-w-0">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-white/50 text-lg mb-1">No products found</p>
              <p className="text-white/30 text-sm mb-6">Try different filters or search terms</p>
              <Link to="/shop" className="btn-gold px-8 py-3 rounded-full text-sm tracking-widest uppercase">Browse All</Link>
            </div>
          ) : (
