...
// Record view (no auth required, no body)
...
// Admin and Vendor products — validate before the controller touches req.body
router.post("/", protect, authorize("admin", "vendor"), validateProduct, createProduct);
router.put("/:id", protect, authorize("admin", "vendor"), validateProductUpdate, updateProduct);
