...
async function autoSeed() {
  ...
  if (count === 0) {
    ...
    const users = [
      { firstName: "Admin", lastName: "TRENDZ", email: "admin@trendz.com", password: "admin123", role: "admin", phone: "9999900000", paymentAccount: { upiId: "trendzadmin@upi", bankName: "HDFC Bank", accountHolder: "TRENDZ Pvt Ltd", accountNumber: "XXXX1234", ifscCode: "HDFC0001234" } },
      { firstName: "Alex", lastName: "Rivera", email: "alex@trendz.com", password: "test1234", role: "user", phone: "9876543210" },
    ];
    ...
    console.log("📧 Admin: admin@trendz.com / admin123");
    console.log("📧 User:  alex@trendz.com / test1234");
  }
}
...
const startServer = async () => {
  ...
  app.listen(PORT, () => {
    console.log(`\n🚀 TRENDZ Server running on port ${PORT}`);
