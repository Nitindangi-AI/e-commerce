  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center p-6 text-center text-white space-y-8 select-none">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
        <button
          onClick={handleRetry}
          className="px-8 py-3.5 bg-[#C9A84C] hover:bg-[#B5963F] text-white text-xs font-bold uppercase tracking-widest rounded transition-all duration-300 shadow-md shadow-[#C9A84C]/10 w-48 sm:w-auto border-0"
        >
          Retry
        </button>
        <a
