            ...
            <div className="space-y-6 animate-fade-in">
              ...
              {ordersLoading ? (
                ...
                <div className={`text-center py-20 border rounded-2xl ${cardBg}`}>
                  ...
                  <h4 className="font-bold text-lg mb-2">No Orders Located</h4>
                  ...
                  <Link to="/shop" className="btn-gold px-6 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider">Start Shopping</Link>
                </div>
              ) : (
